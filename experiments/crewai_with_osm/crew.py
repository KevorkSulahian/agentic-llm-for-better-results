...
# Model Selection
def initialize_llm(model_option, api_key, groq_api_key):
    if model_option == "OpenAI GPT-4o":
        ...
        if not api_key:
            raise ValueError("Hugging Face API key is required for Meta LLaMA model")
...
# print(create_crew("NVDA", "Meta-Llama-3-70B-Instruct", os.environ.get("HUGGINGFACEHUB_API_TOKEN"), "None"))
